...
@ComponentScan(basePackages = "com.udacity.jdnd.course3.critter.configuration")
@PropertySource(value = {"classpath:application.properties"})
@EnableJpaRepositories("com.udacity.jdnd.course3.critter.dao")
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[] {"com.udacity.jdnd.course3.critter.entity"});
